...
HD_PWD='/home/rrr/XP/xup_fpga/lab2/lab2.runs/system_uart_led_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_uart_led_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_uart_led_0_0.tcl
